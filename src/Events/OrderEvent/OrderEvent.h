...
class OrderEvent : public Event {
    public:
    OrderEvent(std::string ticker, std::chrono::system_clock::time_point timestamp, int quantity, OrderDirection direction): ticker_(std::move(ticker)), timestamp_(timestamp), quantity_(quantity), direction_(direction) {}
